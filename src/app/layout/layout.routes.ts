...
export const layoutRoutes: Routes = [
 {
  path: LAYOUT_ROUTES.base, loadComponent: () => import('./layout.component').then(m => m.LayoutComponent), children: [
   ...
   { path: LAYOUT_ROUTES.forgot_password, loadComponent: () => import("../pages/forgot-password/forgot-password").then(m => m.ForgotPassword) },
   { path: LAYOUT_ROUTES.home, loadComponent: () => import("../pages/home/home").then(m => m.Home) },
   { path: LAYOUT_ROUTES.portfolio, loadComponent: () => import("../pages/portfolio/portfolio").then(m => m.Portfolio) },
   { path: LAYOUT_ROUTES.portfolio_create, loadComponent: () => import("../pages/portfolio-create/portfolio-create").then(m => m.PortfolioCreate) },
